...
% Force black body text everywhere
\AtBeginDocument{\color{black}}

% ---------- Phenomenon card -------------------------------
% Pure minipage + fcolorbox: no TikZ baseline issues.
% \phencard{<badge letter>}{<phenomenon name>}{<good Urdu>}{<bad Urdu>}
\newcommand{\phencard}[4]{%
\begin{minipage}[t]{0.31\linewidth}
\fcolorbox{seeblau35}{seeblau20!40}{%
\begin{minipage}[t]{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}
\color{black}%
\tikz\node[circle,fill=seeblau100,text=white,
           inner sep=2pt,minimum size=14pt,
           font=\bfseries\scriptsize]{#1};\,%
\textbf{\small #2}\\[2pt]
\footnotesize
\textcolor{checkgreen}{$\checkmark$}~\foreignlanguage{arabic}{#3}\\
...
{\color{black}\bfseries UrBLiMP: A Benchmark for Evaluating the Linguistic
...
{\color{black}\Large\bfseries ACL\\[-2pt]2026}
...
\begin{tikzpicture}
  \foreach \v/\l/\x in {%
    ...
    \node[circle,draw=seeblau100,line width=1.5pt,fill=seeblau20!50,
          minimum size=2.2cm,align=center,text=black] at (\x*2.4,0)
          {\bfseries\large\v\\[-2pt]\footnotesize \l};
  }
\end{tikzpicture}\\[6pt]
...
\fcolorbox{seeblau100}{white}{%
\begin{minipage}[t]{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}
\color{black}%
\small\textbf{How to read a card:} each badge shows the
\textcolor{checkgreen}{$\checkmark$}~\textbf{grammatical} sentence and the
...
\begin{tikzpicture}[
  ...
  \node[stepbox,right=of s2] (s3) {%
    \textbf{3. Human validation (PCIbex)}\\[3pt]
...
\end{itemize}
\textbf{Metric} -- sentence-level accuracy:
...
\begin{axis}[
   ...
   symbolic y coords={mT5small,mT5large,mBERT,Granite8B,LLaMA8B,
        DeepSeek70B,Gemma12B,Gemma27B,Alif8B,GPT4oCoT,
        LLaMA70B,GPT4oBase,Human,GPT4oGP},
   ytick=data,
   yticklabels={mT5-small,mT5-large,mBERT,Granite-8B,LLaMA-3-8B,
   ...
   tick label style={font=\scriptsize,text=black},
   label style={font=\footnotesize,text=black},
]
\addplot[fill=seeblau100,draw=seeblau100] coordinates {
   (50.69,mT5small) (63.36,mT5large) (78.77,mBERT)
   (87.44,Granite8B) (90.71,LLaMA8B) (92.46,DeepSeek70B)
   (92.68,Gemma12B) (92.42,Gemma27B) (93.25,Alif8B)
   (94.25,GPT4oCoT) (94.73,LLaMA70B) (95.69,GPT4oBase)
   (97.40,GPT4oGP)};
\addplot[fill=seeblau35,draw=seeblau100] coordinates {
   (96.28,Human)};
\draw[red,dashed,thick] (axis cs:96.28,mT5small)
   -- (axis cs:96.28,GPT4oGP)
   node[pos=0.9,above,font=\scriptsize,red] {Human baseline};
\end{axis}
\end{tikzpicture}\\[-4pt]
...
\textbf{Long-distance agreement is hard}\\[3pt]
...
\vfill
\centering
{\footnotesize\textbf{\textit{ACL 2026 Findings
